...
/* =================================================================================
Revision :  code modified reg how EQep registers are accessed
...
{                                                                                       \
   ...
   /* v.ElecTheta = (v.PolePairs*v.MechTheta) - floor(v.PolePairs*v.MechTheta);*/ /* Q24 = Q0*Q24 */ \
    v.ElecTheta = (v.PolePairs*v.MechTheta) - (int)(v.PolePairs*v.MechTheta); /* Q24 = Q0*Q24 */ \
                                                                                        \
...
#define QEP_DIRECTION(eQEP,v)  v.DirectionQep = (*eQEP).QEPSTS.bit.QDF;
