...
override PKGDIR = xconfig_biosConfigCPU1
...
ti.targets.C28_float.rootDir ?= C:/ti/ccs1040/ccs/tools/compiler/ti-cgt-c2000_21.6.0.LTS
...
package/%.xdc.inc package/%_xconfig_biosConfigCPU1.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_biosConfigCPU1" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: biosConfigCPU1.p28FP

-include package/cfg/biosConfigCPU1_p28FP.mak
-include package/cfg/biosConfigCPU1_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/biosConfigCPU1_p28FP.dep
endif
biosConfigCPU1.p28FP: package/cfg/biosConfigCPU1_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
biosConfigCPU1.p28FP package/cfg/biosConfigCPU1_p28FP.c: .libraries,28FP
endif

package/cfg/biosConfigCPU1_p28FP.c package/cfg/biosConfigCPU1_p28FP.h package/cfg/biosConfigCPU1_p28FP.xdl: override _PROG_NAME := biosConfigCPU1.x28FP
package/cfg/biosConfigCPU1_p28FP.c: package/cfg/biosConfigCPU1_p28FP.cfg
package/cfg/biosConfigCPU1_p28FP.xdc.inc: package/cfg/biosConfigCPU1_p28FP.xdl
package/cfg/biosConfigCPU1_p28FP.xdl package/cfg/biosConfigCPU1_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/biosConfigCPU1_p28FP.cfg
	-$(RM) package/cfg/biosConfigCPU1_p28FP.dep
	-$(RM) package/cfg/biosConfigCPU1_p28FP.c
	-$(RM) package/cfg/biosConfigCPU1_p28FP.xdc.inc

clean,28FP::
	-$(RM) biosConfigCPU1.p28FP
.executables,28FP .executables: biosConfigCPU1.x28FP

biosConfigCPU1.x28FP: |biosConfigCPU1.p28FP

-include package/cfg/biosConfigCPU1.x28FP.mak
biosConfigCPU1.x28FP: package/cfg/biosConfigCPU1_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 -z  -o $@ package/cfg/biosConfigCPU1_p28FP.o28FP   package/cfg/biosConfigCPU1_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
biosConfigCPU1.x28FP: export C_DIR=
biosConfigCPU1.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
biosConfigCPU1.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

biosConfigCPU1.test test,28FP test: biosConfigCPU1.x28FP.test

biosConfigCPU1.x28FP.test:: biosConfigCPU1.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 biosConfigCPU1.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.biosConfigCPU1.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,biosConfigCPU1.x28FP,*)


clean:: clean,28FP

clean,28FP::
	-$(RM) biosConfigCPU1.x28FP
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
biosConfigCPU1_p28FP.o28FP,copy : package/cfg/biosConfigCPU1_p28FP.o28FP
biosConfigCPU1_p28FP.s28FP,copy : package/cfg/biosConfigCPU1_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_biosConfigCPU1
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_biosConfigCPU1.tar.dep
endif
package/rel/xconfig_biosConfigCPU1/xconfig_biosConfigCPU1/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_biosConfigCPU1/xconfig_biosConfigCPU1/package/package.rel.xml: package/build.cfg
package/rel/xconfig_biosConfigCPU1/xconfig_biosConfigCPU1/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_biosConfigCPU1/xconfig_biosConfigCPU1/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_biosConfigCPU1.tar: package/rel/xconfig_biosConfigCPU1.xdc.inc package/rel/xconfig_biosConfigCPU1/xconfig_biosConfigCPU1/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_biosConfigCPU1.xdc.inc,package/rel/xconfig_biosConfigCPU1.tar.dep)


release release,xconfig_biosConfigCPU1: all xconfig_biosConfigCPU1.tar
clean:: .clean
	-$(RM) xconfig_biosConfigCPU1.tar
	-$(RM) package/rel/xconfig_biosConfigCPU1.xdc.inc
	-$(RM) package/rel/xconfig_biosConfigCPU1.tar.dep
