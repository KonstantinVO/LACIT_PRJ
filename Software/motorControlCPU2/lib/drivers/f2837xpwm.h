...
Target   : 		  TMS320F2837x family
=====================================================================================*/

#ifndef __F2837X_PWM_H__
#define __F2837X_PWM_H__
...
/*----------------------------------------------------------------------------
Initialization constant for the F2837X Dead-Band Generator registers for PWM Generation.
...
#define PWM_INIT_MACRO(ch1,ch2,ch3,v)										\
         ...
         (*ePWM[ch1]).DBFED.all  = v.Deadband;								\
         (*ePWM[ch1]).DBRED.all  = v.Deadband;								\
         (*ePWM[ch2]).DBFED.all  = v.Deadband;								\
         (*ePWM[ch2]).DBRED.all  = v.Deadband;								\
         (*ePWM[ch3]).DBFED.all  = v.Deadband;								\
         (*ePWM[ch3]).DBRED.all  = v.Deadband;								\
																			\
...
/*  from (-PeriodMax,PeriodMax) to (0,PeriodMax) where HalfPerMax=PeriodMax/2	*/	\
	 																				\
	 (*ePWM[ch1]).CMPA.bit.CMPA = _IQmpy(m.HalfPerMax,m.MfuncC1)+ m.HalfPerMax;	\
	 (*ePWM[ch2]).CMPA.bit.CMPA = _IQmpy(m.HalfPerMax,m.MfuncC2)+ m.HalfPerMax;	\
	 (*ePWM[ch3]).CMPA.bit.CMPA = _IQmpy(m.HalfPerMax,m.MfuncC3)+ m.HalfPerMax;	\



#endif  // __F2837X_PWM_H__
